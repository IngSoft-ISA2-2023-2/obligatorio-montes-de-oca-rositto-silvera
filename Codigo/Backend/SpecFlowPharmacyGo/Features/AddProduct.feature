...
Scenario: Adding a Valid Product Entry
	Given that I input the code 12342  
	...
	#| --------  | ----------------- | ---------------------- | --------- | --------------------------------------- | ------------------------------------------- |
	#| 12342     | Shampoo-Bella     | Para el Cabello        | 50.50     | [Shampoo-Bella]                         | 'Your product has been added to the list'   |
	#| 12557     | Crema para manos  | Tersa y Suave          | 150       | [Shampoo-Bella,Crema para Manos]        | 'Your product has been added to the list'   |
